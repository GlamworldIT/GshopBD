...
class _ProductDetailsState extends State<ProductDetails> {
  _ProductDetailsState(this.userPhone,
      this.userPoint,
      this.productId,
      this.productImage,
      this.productName,
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  ///Ordered Size....
                  productSize == null ? Container() : Container(
  ...
  Future<void> addProductToCart() async {
    ...
    Firestore.instance.collection(userPhone)
    ...
    if (userPoint >= totalAmount) {
      ...
      Firestore.instance.collection(userPhone)
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) =>
            Order(userPhone: userPhone, productID: productId, id: id,)));
      });
    }
    else {
      ///Show Alert Dialog....
      showDialog(context: context,
          ...
          builder: (context) {
            return AlertDialog(
              title: Text("You have not enough coin to buy this product."),
              content: Container(
                height: 110,
                child: Column(
                  children: [
                    Container(
                      child: Text("You need $needPoint more coin",
                        style: TextStyle(
