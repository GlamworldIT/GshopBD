                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                decoration: textInputDecoration.copyWith(hintText: "Full Name",prefixIcon: Icon(Icons.person)),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text("Already have account? ",style: TextStyle(color: Colors.grey[800],fontSize: size.width/25)),
                                    InkWell(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> LogIn()));
                                      },
                                      splashColor: Colors.white,
                                      child: Text("sign in",style: TextStyle(color: Colors.deepOrange,fontSize: size.width/22),
                                      ),
                                    ),
                                  ],
                                ),
    ...
    QuerySnapshot querySnapshot = await Firestore.instance
      ...
      if(users.length==0){
        Firestore.instance.collection("Users").document(phone).setData({
          ...
          setState((){ isLoading = false;errorMgs="";});
